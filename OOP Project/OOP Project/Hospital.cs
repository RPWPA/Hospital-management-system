...
namespace OOP_Project
{
    ...
    public class Patient : Person
    {
       string history;
        ...
        public string get_histroy() { return this.history; }
        public Patient() // default Constructor of patient
        {
            this.Patient_Doctors = new List<string>();
        }
        public List<string> get_doctors() { return this.Patient_Doctors; }
        // parametric constructor
        public Patient(string Name, string Age, string ID, string Phone_number,string dep , string history ,string room , string type)
    ...
    public class Appointment
    {
      ...
      public DateTime get_date() { return this.Datetime; }
